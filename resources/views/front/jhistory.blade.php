<html lang="en" style="margin: 0px auto; font-size: 107.1px;"><head>
  ...
  <title>sites</title>
	<style>
      ...
      .container[data-v-5d4adb0a] {
        background: #07090e !important;
      }
      .white-bg[data-v-5d4adb0a] {
        background: #07090e !important;
      }
      .van-nav-bar {
        background: #07090e !important;
      ...
      .desc[data-v-5d4adb0a] {
        color: rgba(255,255,255,0.7) !important;
      }
      .slip-item[data-v-3509fc58] {
        border-radius: 0.2rem;
        overflow: hidden;
      }
      .slip-item .wrap[data-v-3509fc58] {
        background: linear-gradient(135deg, rgba(26, 30, 46, 0.85), rgba(37, 42, 58, 0.85)) !important;
      }
      .slip-item .time[data-v-3509fc58],
      .slip-item .goods-name[data-v-3509fc58] {
        color: #fff !important;
      }
      .slip-item .title[data-v-3509fc58] {
        color: rgba(255,255,255,0.7) !important;
      }
      .slip-item .money[data-v-3509fc58] {
        color: #00f2fe !important;
      }
      .status-0[data-v-3509fc58] {
        background: rgba(255, 165, 0, 0.2) !important;
        color: #ffa500 !important;
      }
      .status-1[data-v-3509fc58] {
  ...
  <div class="main-layout" data-v-08abc850="">
    ...
    <div class="main-container" data-v-08abc850="">
      ...
      <div class="van-config-provider" data-v-08abc850="" style="--van-primary-color: #00f2fe; --van-button-primary-background-color: #00f2fe;"><div class="container pb10 w100" data-v-5d4adb0a=""><div class="van-nav-bar van-hairline--bottom" data-v-5d4adb0a=""><div class="van-nav-bar__content">
        <a href="journey">
        ...
        foreach ($total as $key => $value) {
         ...
         ?>
        <div class="slip-item" data-v-3509fc58="" data-v-5d4adb0a="" style="background: url(&quot;/backend/productImage/<?php echo $query->productImage; ?>&quot;) 0% 0% / 100% 100% no-repeat;"><div class="wrap" data-v-3509fc58=""><div class="time-line" data-v-3509fc58=""><div class="status status-0" data-v-3509fc58="">Pending</div></div><div class="goods-line align-start flex" data-v-3509fc58=""><div class="flex-column" data-v-3509fc58=""><div class="time" data-v-3509fc58=""><?php echo date('Y-m-d H:i:s', $value['time']); ?></div><div class="goods-name" data-v-3509fc58=""><?php echo $query->productName; ?></div></div></div><div class="item-footer" data-v-3509fc58=""><div class="money-item" data-v-3509fc58=""><span class="title" data-v-3509fc58="">Commissions</span><span class="money" data-v-3509fc58="">Rs <?php echo $value['comission']; ?></span></div><div class="submit-btn" data-v-3509fc58=""><button type="button" data-user-id="<?php echo $value['id']; ?>" class="submit van-button van-button--primary van-button--small van-button--block van-button--round" data-v-3509fc58="" style="background: var(--gradient-text); color: #07090e; border: none; box-shadow: 0 4px 20px rgba(0, 242, 254, 0.3);"><div class="van-button__content"><!----><span class="van-button__text">Submit</span><!----></div></button></div></div></div></div>
<?php }else{ ?>

      <div class="slip-item" data-v-3509fc58="" data-v-5d4adb0a="" style="background: url(&quot;/backend/productImage/<?php echo $query->productImage; ?>&quot;) 0% 0% / 100% 100% no-repeat;"><div class="wrap" data-v-3509fc58=""><div class="time-line" data-v-3509fc58=""><div class="status status-1" data-v-3509fc58="">Completed</div></div><div class="goods-line align-start flex" data-v-3509fc58=""><div class="flex-column" data-v-3509fc58=""><div class="time" data-v-3509fc58=""><?php echo date('Y-m-d H:i:s', $value['time']); ?></div><div class="goods-name" data-v-3509fc58=""><?php echo $query->productName; ?></div></div></div><div class="item-footer" data-v-3509fc58=""><div class="money-item" data-v-3509fc58=""><span class="title" data-v-3509fc58="">Commissions</span><span class="money" data-v-3509fc58="">Rs <?php echo $value['comission']; ?></span></div><div class="submit-btn" data-v-3509fc58=""><!----></div></div></div></div>
<?php }} ?>
