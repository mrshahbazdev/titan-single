    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .deco-line {
            ...
            margin-bottom: 24px;
            animation: fadeSlideUp 0.8s ease-out 0.15s backwards;
        }
        ...
        @media (max-width: 1024px) {
            .brand-section { padding: 40px 30px; text-align: center; align-items: center; }
            .form-section { padding: 40px 30px; border-left: none; border-top: 1px solid var(--border-subtle); }
        ...
        .input-field:focus {
            ...
            box-shadow: 0 0 0 3px rgba(212, 175, 55, 0.1), var(--shadow-glow);
        ...
        .submit-btn {
            ...
            position: relative;
            overflow: hidden;
            animation: fadeSlideUp 0.6s ease-out 0.7s backwards;
        }
        ...
        .auth-footer {
            ...
            color: var(--text-muted);
            font-size: 0.95rem;
            animation: fadeSlideUp 0.6s ease-out 1s backwards;
        }
