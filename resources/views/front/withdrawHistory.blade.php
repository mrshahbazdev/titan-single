  ...
  <div class="main-layout" data-v-08abc850="">
    ...
    <div class="main-container no-footer" data-v-08abc850="">
      ...
      <div class="dark-page">
        <!-- Nav -->
        <div class="dark-nav">
          <a href="deposit" class="dark-nav-back">
          ...
          <span class="dark-nav-title">Transaction History</span>
        ...
        <?php if($users->count() > 0){
          ...
          <div class="dark-history-item">
            <div class="dark-history-header">
              <span class="dark-history-amount">Rs <?php echo $user->amount; ?></span>
              <?php if($user->status == 2){ ?>
                <span class="dark-badge dark-badge-approved">Approved</span>
              <?php }elseif($user->status == 1){ ?>
                <span class="dark-badge dark-badge-pending">Pending</span>
              <?php }elseif($user->status == 0){ ?>
                <span class="dark-badge dark-badge-rejected">Rejected</span>
              <?php } ?>
            </div>
            <div class="dark-history-detail">
              <span class="dark-history-label">Method</span>
              <span class="dark-history-value"><?php echo $user->method; ?></span>
            </div>
            <div class="dark-history-detail">
