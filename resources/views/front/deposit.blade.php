  ...
  <div class="main-layout" data-v-08abc850="">
    ...
    <div class="main-container" data-v-08abc850="">
      ...
      <div class="recharge-section">
        ...
        <div class="form-group">
          <label class="form-label">Payment Screenshot <span style="color: #ff4d4f;">*</span></label>
          <div class="file-upload-area" id="fileUploadArea">
            ...
            <input type="file" name="screenshot" accept="image/*" class="file-input" id="screenshotInput" required>
          </div>
