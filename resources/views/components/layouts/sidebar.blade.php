<!-- Page Body Start-->
      <div class="page-body-wrapper">
        ...
        <div class="sidebar-wrapper" data-layout="stroke-svg">
          <div class="logo-wrapper" style="padding: 8px 0;"><a href="#"><img class="img-fluid" src="{{ asset('assets/uploads/img/crownbridge-logo.png') }}" alt="logo" style="max-width: 120px; height: auto;"></a>
