(function ($) {
  ...
  if ($("#pageWrapper").hasClass("compact-wrapper")) {
    $(".sidebar-title").append(
      '<div class="according-menu fa fa-angle-right"></div>'
    );
    $(".sidebar-title").click(function () {
      ...
      if ($(this).next().is(":hidden") == true) {
        ...
        $(this)
          .find("div")
          .replaceWith(
            '<div class="according-menu fa fa-angle-right"></i></div>'
          );
      }
    });
    ...
    $(".submenu-title").click(function () {
      ...
      if ($(this).next().is(":hidden") == true) {
        ...
        $(this)
          .find("div")
          .replaceWith(
            '<div class="according-menu fa fa-angle-down"></div>'
          );
        $(this).next().slideDown("normal");
      } else {
        $(this)
        ...
        $(".submenu-title").click(function () {
          ...
          if ($(this).next().is(":hidden") == true) {
            ...
            $(this)
              .find("div")
              .replaceWith(
                '<div class="according-menu fa fa-angle-down"></i></div>'
              );
            $(this).next().slideDown("normal");
          } else {
            $(this)
